...
.. meta::
	...
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/exp_minus_one.png.png.
	:og:image: Exponential Minus One: You can save typing by using expm1($x) instead of exp($x) - 1.
