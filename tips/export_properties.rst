...
.. meta::
	...
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/export_properties.png.png.
	:og:image: Exporting Properties: With an accessor and a reference, it is possible to export a private property and manipulate it from the outside of the object.
