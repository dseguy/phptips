...
.. meta::
	...
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/unexpected_keys.png.png.
	:og:image: Unexpected keys in array: It is possible to put 2 elements in a PHP array, find different 5 keys with array_key_exists or isset) and yet, still count 2 distinct elements (key wise).
