...
.. meta::
	...
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/instanceof_class.png.png.
	:og:image: instanceof Object: object is a type, but it can also be used as a constant name.
