...
.. meta::
	...
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/class_is_valid_class.png.png.
	:og:image: Class Is A Valid Type: PHP allows to use ``\class`` as a class name in a type.
