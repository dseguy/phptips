...
.. meta::
	...
	:twitter:description: Scalar Types Are Unqualified: Scalar types, such as ``int`` or ``iterable`` shall be used without the leading slash.
	:twitter:creator: @exakat.
	:twitter:image:src: https://php-tips.readthedocs.io/en/latest/_images/scalar_types_are_unqualified.png.png.
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/scalar_types_are_unqualified.png.png.
	:og:image: Scalar Types Are Unqualified: Scalar types, such as ``int`` or ``iterable`` shall be used without the leading slash.
