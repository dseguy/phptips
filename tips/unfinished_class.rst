...
.. meta::
	...
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/unfinished_class.png.png.
	:og:image: Unfinished Class Doesn't Compile: PHP is not able to use a class before it is defined.
