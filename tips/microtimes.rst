...
.. meta::
	...
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/microtimes.png.png.
	:og:image: Reading Micro-seconds: There are different ways to access micro seconds in PHP : use the Datetime format of ``u``, which works with Datetime.
