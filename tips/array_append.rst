...
.. meta::
	...
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/array_append.png.png.
	:og:image: array_append() And Short Assignation: PHP allows using short assignation operators with the array append operators.
