...
.. meta::
	...
	:twitter:image:src: https://php-tips.readthedocs.io/en/latest/_images/misplaced_parenthesis.png.png.
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/misplaced_parenthesis.png.png.
	:og:image: A Case Of Misplaced Parenthesis: The closing parenthesis of the in_array() call may be misplaced, yet yield a valid PHP code, and even, a valid business case.
