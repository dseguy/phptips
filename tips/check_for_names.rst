...
.. meta::
	...
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/check_for_names.png.png.
	:og:image: Checking For Names At Different Times: PHP lint detects early to avoid 'redeclared functions', based on local compilation.
