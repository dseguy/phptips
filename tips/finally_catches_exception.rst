...
.. meta::
	...
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/finally_catches_exception.png.png.
	:og:image: Finally Catches Exception: In this code, finally is executed after the throw.
