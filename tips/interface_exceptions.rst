...
.. meta::
	...
	:og:image: https://php-tips.readthedocs.io/en/latest/_images/interface_exceptions.png.png.
	:og:image: Exception Polyphormism: Customs exceptions are classes like any others: they may implements an interface.
