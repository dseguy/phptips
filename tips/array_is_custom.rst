.. _\array-is-customizable:

\array Is Customizable
----------------------

	.. meta::
		:description lang=en:
			\array Is Customizable: This code gathers several PHP hacks together.

This code gathers several PHP hacks together. First, the naming of an anonymous class, and this time, it is renamed as ``\array``.
